import SemiProduct = require('../API/ComputeEngine/Manufacturing/src/SemiProduct');
import Product = require('../API/ComputeEngine/Manufacturing/src/Product');
import SubContracter = require('../API/ComputeEngine/Manufacturing/src/SubContracter');
